    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ref.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                // قائمة الكلمات،  (2^5 = 32)
                val words = listOf(
                    "Father", "not found UNtil now", "not found UNtil now", "not found UNtil now", "Favorite", "not found UNtil now", "Why", "not found UNtil now", "not found UNtil now", "not found UNtil now", "not found UNtil now", "not found UNtil now", "not found UNtil now", "not found UNtil now", "sorry","not found UNtil now", "Hello", "not found UNtil now", "not found UNtil now", "Eight", "not found UNtil now", "not found UNtil now", "Hearing", "Deaf", "not found UNtil now", "not found UNtil now", "not found UNtil now", "not found UNtil now", "not found UNtil now", "not found UNtil now", "Zero"
                )
