    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ref.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                val words = listOf(
                    "Mother", "not found until now", "not found until now",
                    "Horse", "Feel", "not found until now", "Love", "Ok", "not found until now", "not found until now", "not found until now", "not found until now", "not found until now", "Call", "Great",
                    "Four", "Water", "Seven", "Goat", "Like", "not found until now", "not found until now", "I am", "not found until now", "not found until now", "not found until now", "not found until now",
                    "not found until now", "not found until now", "Idea", "Five")
